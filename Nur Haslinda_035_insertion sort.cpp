...
int main(){
    ...
    //looping untuk memasukkan list array
    for(looping1=0; looping1<batas_elemen; looping1++)
    {
    	cout << "Elemen ke-"<<looping1<< ": ";
    	
    	//perintah memasukkan elemen erray
    ...
    for(looping1=1; looping1<=batas_elemen-1; looping1++)
    {
        ...
        while((temp<input_elemen[looping2])&&(looping2>=0))
        {
        	//perintah memindahkan elemen array kedepan sesuai urutan
    ...
    //looping untuk menampilkan hasil sorting
    for(looping1=0; looping1<batas_elemen; looping1++)
    {
